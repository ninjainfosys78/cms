        ...
        <div class="card flex items-center p-5">
            <nav class=" w-full  flex items-center justify-between" aria-label="Global">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.farmerCooperatives.create') }}"
        ...
        <div class="col-lg-12 overflow-hidden d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Farmer Cooperatives</h5>
                    <div class="table-responsive">
                        <table class="table text-nowrap mb-0 align-middle">
                            ...
                            <tbody>
                                @foreach ($farmerCooperatives as $farmer)
                                    <tr>
                                        ...
                                        <td class="border-b border-gray-200 gap-2 flex">
                                            <a href="{{ route('admin.farmerCooperatives.edit', $farmer) }}"><i
                                                    class="ti ti-edit text-[18px] text-white hover:bg-blue-500 bg-green-500 p-2 rounded-full"></i></a>
                                            <a href=""><i class=""></i></a>


                                            <form action="{{ route('admin.farmerCooperatives.destroy', $farmer) }}"
                        ...
                        {{-- <div class="mt-4">
                            {{ $farmerCooperatives->onEachSide(5)->links('vendor.pagination.bootstrap-5') }}
                        </div> --}}
                    </div>
                </div>
            </div>
