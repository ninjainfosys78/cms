        ...
        <div class="card flex items-center p-5">
            <nav class=" w-full  flex items-center justify-between" aria-label="Global">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.cooperative.create') }}"
        ...
        <div class="col-lg-12 overflow-hidden d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Cooperatives</h5>
                    <div class="table-responsive">
                                ...
                                @foreach ($cooperatives as $cooperative)
                                    <tr>
                                        ...
                                        <td class="border-b border-gray-200 gap-2 flex">
                                            ...
                                            <form action="{{ route('admin.cooperative.destroy', $cooperative) }}"
                        ...
                        {{-- <div class="mt-4">
                            {{ $cooperative->onEachSide(5)->links('vendor.pagination.bootstrap-5') }}
                        </div> --}}
                    </div>
                </div>
            </div>
