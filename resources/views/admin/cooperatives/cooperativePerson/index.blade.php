        ...
        <div class="card flex items-center p-5">
            <nav class=" w-full  flex items-center justify-between" aria-label="Global">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.cooperativePerson.create') }}"
        ...
        <div class="col-lg-12 overflow-hidden d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Cooperative Person</h5>
                    <div class="table-responsive">
                        <table class="table text-nowrap mb-0 align-middle">
                            <thead class="text-dark fs-4">
                                <tr class="border border-1">
                                    ...
                                    {{-- <th class="border-right-1">
                                        <h6 class="fw-semibold mb-0">Cooperative Id</h6>
                                    </th> --}}
                                    <th class="border-right-1">
                            ...
                            <tbody>
                                @foreach ($cooperativePeople as $cooperativePerson)
                                    <tr>
                                        <td class="border-b border-gray-200">
                                            <h6 class=" mb-0">{{ $loop->iteration }}</h6>
                                        </td>
                                        <td class="border-b border-gray-200">
                                            <h6 class=" mb-1">{{ $cooperativePerson->name ?? '' }}</h6>
                                        </td>
                                        <td class="border-b border-gray-200">
                                            <h6 class=" mb-1">{{ $cooperativePerson->phone ?? '' }}</h6>
                                        </td>
                                        <td class="border-b border-gray-200">
                                            <h6 class=" mb-1">{{ $cooperativePerson->designation ?? '' }}</h6>
                                        </td>
                        ...
                        {{-- <div class="mt-4">
                            {{ $cooperativePerson->onEachSide(5)->links('vendor.pagination.bootstrap-5') }}
                        </div> --}}
                    </div>
                </div>
            </div>
