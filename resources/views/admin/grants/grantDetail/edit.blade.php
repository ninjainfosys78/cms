    ...
    <div class="container full-container py-5 flex flex-col gap-6">
        ...
        <div class="">
            <div class="flex flex-col gap-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="flex flex-col gap-6" action="{{route('admin.grantDetail.update',$grantDetail)}}" method="POST"
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                name="grant_id"
                                :options="$grant"
                                selected="{{ $grantDetail->grant_id }}"
                                />

                                <livewire:grant-detail
                                :selectedModelType="$grantDetail->model_type ?? null"
                                {{-- :modelIds="$grantDetail->model_id ?? null" --}}
                                />
                                ...
                                <x-forms.TextInput
                                 ...
                                 value="{{ $grantDetail->personal_investment }}"
                                />
                                ...
                                <x-forms.TextInput
                                    ...
                                    value="{{ $grantDetail->investment_amount }}"
                                />

                            {{-- </div> --}}

                                <livewire:dependent-dropdown
                                :selectedProvince="$grantDetail->province_id ?? null"
                                :selectedDistrict="$grantDetail->district_id ?? null"
                                :selectedLocalBody="$grantDetail->local_body_id ?? null"
                                />
                            ...
                            {{-- <div class="grid grid-cols-2 gap-4"> --}}
                                ...
                                value="{{ $grantDetail->contact_person }}"
                                />
