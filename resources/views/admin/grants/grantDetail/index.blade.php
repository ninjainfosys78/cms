        ...
        <div class="card flex items-center p-5">
            <nav class=" w-full  flex items-center justify-between" aria-label="Global">
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.grantDetail.create') }}"
        ...
        <div class="col-lg-12 overflow-hidden d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Grant Detail</h5>
                    <div class="table-responsive">
                            ...
                            <thead class="text-dark fs-4">
                                <tr class="border border-1">
                                    ...
                                    <th class="border-right-1">
                                        <h6 class="fw-semibold mb-0">Investment Amount</h6>
                                    </th>
                            ...
                            <tbody>
                                ...
                                @foreach ($grantDetails as $grantDetail)
                                    <tr>
                                        ...
                                        <td class="border-b border-gray-200">
                                            <h6 class=" mb-1">{{ $grantDetail->investment_amount ?? '' }}</h6>
                                        </td>

                                        {{-- <td class="border-b border-gray-200">
                                            <h6 class=" mb-1">{{ $grantDetail->designation ?? '' }}</h6>
                                        </td> --}}

                                        <td class="border-b border-gray-200 gap-2 flex">
                                            <a href="{{ route('admin.grantDetail.edit', $grantDetail) }}"><i
                                                    class="ti ti-edit text-[18px] text-white hover:bg-blue-500 bg-green-500 p-2 rounded-full"></i></a>
                                            <a href=""><i class=""></i></a>


                                            <form action="{{ route('admin.grantDetail.destroy', $grantDetail) }}"
                        ...
                        {{-- <div class="mt-4">
                            {{ $grantDetails->onEachSide(5)->links('vendor.pagination.bootstrap-5') }}
                        </div> --}}
                    </div>
                </div>
            </div>
