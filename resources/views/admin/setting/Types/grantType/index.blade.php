        ...
        <div class="card flex items-center p-5">
            <nav class="w-full flex items-center justify-between" aria-label="Global">
                                    ...
                                    <a href="#"
                                        class="motion-reduce:transition-none-none text-black/60 transition duration-200
                                         hover:text-black/80 hover:ease-in-out focus:text-black/80
                                          active:text-black/80 motion-reduce:transition motion-reduce:transition-none">Grant Type
                                         List</a>
                                </li>
                                <li><span class="mx-2 text-black/60">/</span></li>
                                <li>
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.grantType.create') }}"
        ...
        <div class="col-lg-12 overflow-hidden d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Grant Types</h5>
                            ...
                            <tbody>
                                @foreach ($grantTypes as $grantType)
                                    <tr>
                                        ...
                                        <td class="border-b border-gray-200">
                                            <h6 class="mb-1">{{ $grantType->title ?? '' }}</h6>
                                        </td>
                    ...
                    <!-- Pagination Links -->
                    <div class="mt-4">
                        {{ $grantTypes->links('vendor.pagination.bootstrap-5') }}
                    </div>
