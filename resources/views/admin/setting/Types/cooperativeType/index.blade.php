        ...
        <div class="card flex items-center p-5">
            <nav class="w-full flex items-center justify-between" aria-label="Global">
                    ...
                    <li class="relative">
                        <nav class="w-full rounded-md" aria-label="breadcrumb">
                            <ol class="list-reset ms-2 flex">
                                ...
                                <li>
                                    <a href="#"
                                        class="motion-reduce:transition-none-none text-black/60 transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition motion-reduce:transition-none">Cooperative Type
                                         List</a>
                                </li>
                                <li><span class="mx-2 text-black/60">/</span></li>
                                <li>
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.cooperativeType.create') }}"
        ...
        <div class="col-lg-12 overflow-hidden d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Cooperative Types</h5>
                            ...
                            <tbody>
                                @foreach ($cooperativeTypes as $cooperativeType)
                                    <tr>
                                        ...
                                        <td class="border-b border-gray-200">
                                            <h6 class="mb-1">{{ $cooperativeType->title ?? '' }}</h6>
                                        </td>
                                        <td class="border-b border-gray-200 gap-2 flex">
                                            <a href="{{ route('admin.cooperativeType.edit', $cooperativeType) }}">
                                                <i
                                                    class="ti ti-edit text-[18px] text-white hover:bg-blue-500 bg-green-500 p-2 rounded-full"></i>
                                            </a>
                                            <form action="{{ route('admin.cooperativeType.destroy', $cooperativeType) }}"
                    ...
                    <!-- Pagination Links -->
                    <div class="mt-4">
                        {{ $cooperativeTypes->links('vendor.pagination.bootstrap-5') }}
                    </div>
