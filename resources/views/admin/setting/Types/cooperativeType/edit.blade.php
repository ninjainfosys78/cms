        ...
        <div class="card flex items-center p-5">
            <nav class=" w-full  flex items-center justify-between" aria-label="Global">
                                    ...
                                    <a href="#"
                                        class="motion-reduce:transition-none-none
                                         text-black/60 transition duration-200 hover:text-black/80 hover:ease-in-out
                                          ...
                                          motion-reduce:transition-none ">Cooperative Types
                                        </a>
                                </li>
                                <li>
                                    <span class="mx-2 text-black/60">/</span>
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.cooperativeType.index') }}"
                        class="btn font-medium bg-blue-600 hover:bg-red-600 py-1 text-white" aria-current="page">Cooperative Types List</a>
                </div>
            </nav>
        </div>
        <div class="">
            <div class="flex flex-col gap-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <form class="flex flex-col gap-6" action="{{route('admin.cooperativeType.update',$cooperativeType)}}" method="POST"
                              enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="grid grid-cols-2 gap-4">
                                <x-forms.TextInput
                                    label="Cooperative Type Name "
                                    id="title"
                                    name="title"
