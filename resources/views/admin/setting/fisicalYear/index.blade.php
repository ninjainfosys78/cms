        ...
        <div class="card flex items-center p-5">
            <nav class=" w-full  flex items-center justify-between" aria-label="Global">
                    ...
                    <li class="relative">
                        <nav class="w-full rounded-md" aria-label="breadcrumb">
                            <ol class="list-reset ms-2 flex">
                                ...
                                <li>
                                    <a href="#"
                                        class="motion-reduce:transition-none-none text-black/60 transition duration-200 hover:text-black/80 hover:ease-in-out focus:text-black/80 active:text-black/80 motion-reduce:transition motion-reduce:transition-none ">Fisical
                                        year
                                        List</a>
                                </li>
                                <li>
                ...
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.fisicalYear.create') }}"
        ...
        <div class="col-lg-12 overflow-hidden d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Fisical Years</h5>
                    <div class="table-responsive">
                        <table class="table text-nowrap mb-0 align-middle">
                            <thead class="text-dark fs-4">
                                <tr class="border border-1">
                                    ...
                                    <th class="border-right-1">
                                        <h6 class="fw-semibold mb-0">Fisical Year</h6>
                                    </th>
                            ...
                            <tbody>
                                @foreach ($fisicalYears as $fisicalYear)
                                    <tr>
                                        <td class="border-b border-gray-200">
                                            <h6 class=" mb-0">{{ $loop->iteration }}</h6>
                                        </td>
                                        <td class="border-b border-gray-200">
                                            <h6 class=" mb-1">{{ $fisicalYear->year ?? '' }}</h6>
                                        </td>
                                        <td class="border-b border-gray-200 gap-2 flex">
                                            <a href="{{ route('admin.fisicalYear.edit', $fisicalYear) }}"><i
                                                    class="ti ti-edit text-[18px] text-white hover:bg-blue-500 bg-green-500 p-2 rounded-full"></i></a>
                                            <a href=""><i class=""></i></a>


                                            <form action="{{ route('admin.fisicalYear.destroy', $fisicalYear) }}"
